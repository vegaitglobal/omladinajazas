...
function skt_strong_scripts() {
  ...
  wp_enqueue_script( 'skt-strong-quiz-js', get_template_directory_uri() . '/js/watu/risk_calculator.js' );
  wp_enqueue_script( 'skt-strong-test-js', get_template_directory_uri() . '/js/watu/knowledge_test.js' );
